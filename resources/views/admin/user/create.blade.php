            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Alamat Email" value="{{ isset($user) ? $user->email : '' }}">
                    ...
                    <a href="/admin/user" class="btn btn-secondary"><i class="fas fa-arrow-left">&nbsp</i>Kembali</a>
                    <button type="submit" class="btn btn-success"><i class="fas fa-save">&nbsp</i>Simpan Data</button>
                </form>
